...
def get_products(request, pk):
    ...
    return products_qs, category, search_query, price_min, price_max, in_stock_only, main_only, sort_option
...
def category_products_api(request, pk):
    ...
    products_qs, category, search_query, price_min, price_max, in_stock_only, main_only, sort_option = get_products(request, pk)
    # Пагинация
